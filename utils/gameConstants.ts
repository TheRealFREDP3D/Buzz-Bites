...
export const GAME_CONFIG = {
  ...
  DIFFICULTY_AI_SPAWN_INCREMENT: 0.01,
  DIFFICULTY_AI_ECONOMY_INCREMENT: 0.05,
  DIFFICULTY_AI_ELITE_INCREMENT: 0.03,
  DIFFICULTY_AI_SPECIAL_INCREMENT: 0.02,

  // Difficulty Scaling Clamp Limits
  DIFFICULTY_AI_SPAWN_MAX: 0.25,
  DIFFICULTY_AI_ECONOMY_MAX: 0.95,
  DIFFICULTY_AI_ELITE_MAX: 0.70,
  DIFFICULTY_AI_SPECIAL_MAX: 0.50,
